...
query = ' '.join([
    'SELECT ?item ?label_en ?label_ru',
    'WHERE { ',
        '{ ?item wdt:P31 wd:Q835714 } UNION',      # Oblast of Russia
        '{ ?item wdt:P31 wd:Q41162 } UNION',      # Republic of Russia
        '{ ?item wdt:P31 wd:Q831740 } UNION',     # Krai of Russia
        '{ ?item wdt:P31 wd:Q309166 } UNION',     # Autonomus oblast of Russia
        '{ ?item wdt:P31 wd:Q184122 }',           # Autonomus okrug of Russia

        'FILTER NOT EXISTS {?item wdt:P31 wd:Q19953632}',    # Former administrative territorial entity
