...
for item in generator:
    ...
    line = u'{0} | {1} | {2} | {3} | {4}'.format(qcity_id, region_id, qcountry_id, name_en, name_ru)
    print line
    file_out.write( line.encode('utf-8') + "\n" )

                         # city_id                                             # city_id     country_id
    sql = u"INSERT INTO cities VALUES ({0}, {1}, {2}, '{3}', '{4}');".format(city_id, region_id_sql, country_id, name_en, name_ru)
